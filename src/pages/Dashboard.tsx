      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-indigo-600 text-white px-5 py-2.5 rounded-lg
            ...
            active:bg-indigo-800 w-full sm:w-auto text-sm sm:text-base font-medium cursor-pointer"
        >
          <FiPlus size={18} />
          Create New Test
        </button>
                  ...
                  >
                    ...
                    <td className="px-4 py-4">
                      <div className="flex justify-end items-center gap-2 sm:gap-3">
                        <button className="p-2 rounded-lg hover:bg-blue-50 text-blue-600 transition-colors cursor-pointer">
                          <FiEye size={18} />
                        </button>

                        <button
                          onClick={() => navigate(`/tests/${test.id}/edit`)}
                          className="p-2 rounded-lg hover:bg-green-50 text-green-600 transition-colors cursor-pointer"
                        >
                          <FiEdit size={18} />
                        </button>

                        <button className="p-2 rounded-lg hover:bg-red-50 text-red-600 transition-colors cursor-pointer">
                          <FiTrash2 size={18} />
                        </button>
                      </div>
                    </td>
